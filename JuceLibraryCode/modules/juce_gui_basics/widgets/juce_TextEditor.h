...
public:
    ...
    */
    ...
    Array<std::function<void()>> onTextChangeDelegates;
    ...
    /** You can assign a lambda to this callback object to consume key presses. */
    std::function<bool(const KeyPress&)> onKeyPressed = nullptr;

    Array<KeyPress> keyPressesNotConsumed;

    /** consume key presses that don't affect the text editor */
    bool consumeNoEffectKeyPresses = false;
